...
resource "tfe_notification_configuration" "aws-dev-slack-assareh" {
...
# AWS credentials
resource "tfe_variable" "dev_access_key" {
...
resource "tfe_variable" "dev_secret_key" {
